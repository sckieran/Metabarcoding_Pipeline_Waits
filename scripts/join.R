...
colnames(df2) <- c("sequence","seqnum","remote_identity","remote_species","remote_taxid","remote_phylum","remote_class","remote_order","remote_family","remote_genus","remote_bitscore","remote_num_spec_in_best_hit","remote_all_spec_in_best_hit")
