...
blastn -db nt -query ${dirr}/${gene}_dada_out/${prefix}_${gene}_combined_ASVs.fasta -outfmt '6 qseqid sacc pident length stitle staxid' -out ${prefix}_${gene}_raw_blast_out -remote -max_target_seqs 20
...
do
        ...
        then
                ...
                then
                        ...
                        lin=$($ln)
                        st=$(echo $lin | awk -F"\t"  -v OFS='\t' '{print $1,$3,$5,$6}')
                        taxid=$(echo $lin | awk -F"\t" '{print $5}')
